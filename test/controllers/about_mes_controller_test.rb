...
class AboutMesControllerTest < ActionController::TestCase
  ...
  test "should create about_me" do
    assert_difference('AboutMe.count') do
      post :create, about_me: { batchelers: @about_me.batchelers, colege: @about_me.colege, dob: @about_me.dob, name: @about_me.name, native: @about_me.native, schooling: @about_me.schooling }
    end
  ...
  test "should update about_me" do
    patch :update, id: @about_me, about_me: { batchelers: @about_me.batchelers, colege: @about_me.colege, dob: @about_me.dob, name: @about_me.name, native: @about_me.native, schooling: @about_me.schooling }
    assert_redirected_to about_me_path(assigns(:about_me))
  end
